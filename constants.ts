...
export const QUESTIONS: Question[] = [
  // E vs I
  {
    ...
    axis: "EI",
    options: [
      { text: "友達と遊んだり、賑やかな場所へ行く", value: "E" },
      { text: "家でゆっくりしたり、一人時間を楽しむ", value: "I" },
    ],
  ...
  },
  {
    ...
    axis: "EI",
    options: [
      { text: "自分から積極的に話しかけるほう", value: "E" },
      { text: "相手が話してくれるのを待つほう", value: "I" },
    ],
    imagePath: "/images/questions/q2.png",
  },
  {
    id: 3,
    text: "忙しい一週間の後、元気をチャージするには？",
    axis: "EI",
    options: [
      { text: "誰かと会って話すこと", value: "E" },
      { text: "静かに一人で過ごすこと", value: "I" },
    ],
  ...
  {
    id: 4,
    text: "新しいことを学ぶとき、気になるのは？",
    axis: "SN",
    options: [
      { text: "具体的な手順や事実", value: "S" },
      { text: "その背景にある理論や可能性", value: "N" },
    ],
    imagePath: "/images/questions/q4.png",
  },
  {
    id: 5,
    text: "物事を判断するときに重視するのは？",
    axis: "SN",
    options: [
      { text: "これまでの経験や実績", value: "S" },
      { text: "直感やひらめき", value: "N" },
    ],
  ...
  },
  {
    ...
    axis: "SN",
    options: [
      { text: "現実的で地に足がついている", value: "S" },
      { text: "想像力豊かで夢見がち", value: "N" },
    ],
  ...
  // T vs F
  {
    ...
    axis: "TF",
    options: [
      { text: "論理的にメリット・デメリットを考える", value: "T" },
      { text: "自分の価値観や周りへの影響を考える", value: "F" },
    ],
    imagePath: "/images/questions/q7.png",
  },
  {
    id: 8,
    text: "友達が落ち込んでいるとき、まずは...",
    axis: "TF",
    options: [
      { text: "解決策やアドバイスをする", value: "T" },
      { text: "共感して話を聞いてあげる", value: "F" },
    ],
  ...
  },
  {
    ...
    axis: "TF",
    options: [
      { text: "「仕事ができる」「頭がいい」", value: "T" },
      { text: "「優しい」「気配りができる」", value: "F" },
    ],
  ...
  // J vs P
  {
    ...
    axis: "JP",
    options: [
      { text: "整理整頓されていることが多い", value: "J" },
      { text: "散らかっているが、どこに何があるかはわかる", value: "P" },
    ],
  ...
  },
  {
    ...
    axis: "JP",
    options: [
      { text: "しっかりスケジュールを立てたい", value: "J" },
      { text: "現地で気ままに決めたい", value: "P" },
    ],
  ...
  },
  {
    ...
    axis: "JP",
    options: [
      { text: "余裕を持って終わらせたい", value: "J" },
      { text: "ギリギリになってエンジンがかかる", value: "P" },
    ],
